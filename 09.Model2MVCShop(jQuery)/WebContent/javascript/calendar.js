		   ...
		   var arr_months = ["1월", "2월", "3월", "4월", "5월", "6월","7월", "8월", "9월", "10월", "11월", "12월"]; 
			...
			else
			{
		        ...
		        var str_buffer = new String (
	                    ...
	                    "A:visited {font-size: 11px; color: #222222; text-decoration: none; font-family:verdana, 바탕}\n"+
	                    "A:active  {font-size: 11px; color: #222222; text-decoration: none; font-family:verdana, 바탕}\n"+
	                    "A:hover   {font-size: 11px; color: #222222; text-decoration: none; font-family:verdana, 바탕}\n"+
	                    "</style>\n"+ 
		                "</head>\n"+
